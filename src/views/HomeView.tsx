...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  return (
    <div className="space-y-5 max-w-4xl mx-auto pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 overflow-x-auto py-0.5">
        <div className="flex items-center gap-1 p-1 bg-gray-100/90 rounded-full text-xs font-semibold overflow-x-auto scrollbar-none w-full sm:w-auto shrink-0">
          <button
            onClick={() => setSubTab("dashboard")}
            className={`flex-1 sm:flex-initial px-3.5 py-1.5 rounded-full transition-all text-center whitespace-nowrap ${
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <button
            ...
            className="flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-full bg-white hover:bg-gray-50 border border-gray-200 text-gray-900 text-xs font-bold shadow-xs active:scale-95 transition-all"
          >
            <Camera className="w-4 h-4 text-gray-900 shrink-0" />
            <span>AI Camera</span>
          </button>
          <button
            onClick={() => onOpenFoodLogger("lunch", "ai_parser")}
            id="btn-quick-log-hero"
            className="flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-4 py-2 rounded-full bg-gray-900 hover:bg-black text-white text-xs font-bold shadow-xs active:scale-95 transition-all"
          >
